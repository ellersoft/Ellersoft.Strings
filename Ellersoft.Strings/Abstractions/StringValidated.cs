...
namespace Ellersoft.Strings
{
    ...
    public abstract class StringValidated
        : IComparable, IEnumerable<char>, IComparable<string>, IComparable<StringValidated>, IEquatable<string>, IEquatable<StringValidated>, IXmlSerializable
    {
        protected abstract string ErrorRequirement { get; }
        protected virtual Exception Exception => new ArgumentException(ErrorRequirement);
        ...
        public static int Compare(StringValidated strA, StringValidated strB) =>
            ...
            string.Compare(strA.Value, strB.Value);
        
        [SecuritySafeCritical]
        public static int Compare(StringValidated strA, StringValidated strB, StringComparison comparisonType) =>
            string.Compare(strA.Value, strB.Value, comparisonType);
        
        public static int Compare(StringValidated strA, int indexA, StringValidated strB, int indexB, int length) =>
            string.Compare(strA.Value, indexA, strB.Value, indexB, length);
        
        [SecuritySafeCritical]
        public static int Compare(StringValidated strA, int indexA, StringValidated strB, int indexB, int length, StringComparison comparisonType) =>
            string.Compare(strA.Value, indexA, strB.Value, indexB, length, comparisonType);

        public static int CompareOrdinal(StringValidated strA, StringValidated strB) =>
            string.CompareOrdinal(strA.Value, strB.Value);
        
        [SecuritySafeCritical]
        public static int CompareOrdinal(StringValidated strA, int indexA, StringValidated strB, int indexB, int length) =>
            string.CompareOrdinal(strA.Value, indexA, strB.Value, indexB, length);

        public static bool Equals(StringValidated a, StringValidated b) =>
            string.Equals(a.Value, b.Value);
        
        [SecuritySafeCritical]
        public static bool Equals(StringValidated a, StringValidated b, StringComparison comparisonType) =>
            string.Equals(a.Value, b.Value, comparisonType);
